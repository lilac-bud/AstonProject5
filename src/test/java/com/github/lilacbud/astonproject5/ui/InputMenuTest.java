...
public class InputMenuTest {
    ...
    @Test()
    void createInputMenu() throws ExitException {
    ...
    @Test()
    void inputValue() throws ExitException {
    ...
    @Test()
    void stripInputValue() throws ExitException {
        var userInput = "   Test input string   ";
    ...
    @Test()
    void outputValue() throws ExitException {
        var userInput = "Test input string";
        var expectedInput = userInput;
